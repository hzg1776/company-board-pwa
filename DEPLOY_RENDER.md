...
8. Enter a secure `HR_PIN` when Render asks for secret environment variables.
9. Click **Apply**.
...
Employees can view the board directly. HR access is only required for publishing and branding changes.
