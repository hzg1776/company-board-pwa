...
- Employee portal: `https://<your-host>/palzivalerts/employee`
...
3. You will see the publishing and employee management dashboard.
...
3. Confirm service dashboard and health status.
